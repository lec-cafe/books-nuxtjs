...
```
- 方法3: 以下のコードをpackage.jsonに追加する
```
"scripts": {
  "dev": "HOST=0.0.0.0 PORT=3333 nuxt"
}
```
- 方法4: 環境変数HOSTとPORTを他の用途に使用していた場合に、以下のコードをpackage.jsonに追加する
```
"scripts": {
  "dev": "NUXT_HOST=0.0.0.0 NUXT_PORT=3333 nuxt"
}
```
- 方法5: 方法4をクロスプラットフォームに対応させるために、以下の手順を行う
